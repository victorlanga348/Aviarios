      ...
      {isOpen && (
        ...
        >
          <motion.div 
            ...
            className="bg-card border border-red-500/20 p-5 md:p-8 rounded-2xl w-full max-w-md max-h-[calc(100dvh-2rem)] shadow-2xl my-4 sm:my-0 overflow-y-auto overflow-x-hidden"
